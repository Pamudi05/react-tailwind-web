  ...
  return (
    <>
      <div className="min-h-[150px] bg-black flex justify-start md:justify-center items-center md:items-center">
        <footer className="m-4 ml-8 text-center text-white">
          <p className="text-[15px]">Frontend Practice - &copy; 2024 </p>
          <div className="md:w-[800px] cursor-pointer p-4" ref={containerRef}>
            <ul className="flex flex-col items-start flex-grow space-x-0 font-mono text-sm font-bold md:justify-center md:flex-row md:space-x-6">
